#tellraw @s {"text": "\n---------------------- Info ----------------------\n","color": "green"}
tellraw @s [{"text": "\nNether Star Duplication ","color": "light_purple"},{"text": "2.1 ","color": "gray"},{"text": "|| ","color": "white"},{"text": "Made By ","color": "white"},{"text": "[Sul4ur]","color": "blue","clickEvent": {"action": "open_url","value": "https://www.planetminecraft.com/member/sul4ur/"}},{"text": "."}]
